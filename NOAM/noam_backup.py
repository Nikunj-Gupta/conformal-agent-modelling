...
from tianshou.policy import BasePolicy, DQNPolicy, PPOPolicy, MultiAgentPolicyManager, RandomPolicy
...
def get_env(render_mode=None):
    ...
    return PettingZooEnv(simple_spread_v2.env(N=2, local_ratio=0.5, max_cycles=25, continuous_actions=True))
