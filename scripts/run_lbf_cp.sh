...
tensorboard --logdir="./debug_logs/lbf-cp-padding" --host 0.0.0.0 --load_fast false &
time python cam-lbf/cp-padded.py --cp_update_timestep=$cp_update_timestep --log_dir="./debug_logs/lbf-cp-padding" --seed=$runs 